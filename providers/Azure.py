...
class AzureProvider(Generator):
    def __init__(self, config):
        ...
        self.ws_azure_repos = create_connection(f"{self.config.WS_AZ_REPOS}")
        self.ws_azure_actions = create_connection(f"{self.config.WS_AZ_ACTIONS}")
    ...
    def _generate_pull_request_closed_event(self):
        ...
        self.ws_azure_repos.send(json.dumps(body))
    ...
    def _generate_pipeline_execution_event(self):
        ...
        self.ws_azure_actions.send(json.dumps(body))
