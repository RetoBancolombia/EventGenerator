...
class GithubProvider(Generator):
    def __init__(self, config):
        ...
        self.ws_github_repos = create_connection(f"{self.config.WS_GH_REPOS}")
        self.ws_github_actions = create_connection(f"{self.config.WS_GH_ACTIONS}")
    ...
    def _generate_pull_request_closed_event(self):
        ...
        self.ws_github_repos.send(json.dumps(body))
    ...
    def _generate_workflow_run_event(self):
        ...
        self.ws_github_actions.send(json.dumps(body))
